...
const customChartSources: CustomChartSourcesResponse = {
  sources: [
    ...
    { id: 'dgs10', name: '米国10年国債利回り', axis_group: 'rate_pct1', axis_label: '%', default: true },
    { id: 'baa10y', name: '米国Baa社債スプレッド', axis_group: 'rate_pct1', axis_label: '%', default: false },
    { id: 'sp500', name: 'S&P 500', axis_group: 'price_usd1', axis_label: 'USD', default: false },
    { id: 'sp500_yoy', name: 'S&P 500 前年比', axis_group: 'ratio1', axis_label: '倍率', default: false },
    { id: 'dtwexbgs', name: 'ドル指数 (実効為替レート)', axis_group: 'index1', axis_label: '指数', default: false },
    { id: 'score', name: '投資環境スコア（堀井）', axis_group: 'other', axis_label: 'スコア', default: false },
  ],
  axis_groups: {
